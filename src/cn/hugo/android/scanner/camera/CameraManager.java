...
public final class CameraManager {
	...
	private boolean issetViewCall=false;
	private Handler setView_handler;//设置界面适配
	...
	public synchronized Rect getFramingRect() {
		...
		if(!issetViewCall){
			...
			msg.what=CaptureActivity.SET_VIEW;
			msg.obj=framingRect;
			setView_handler.sendMessage(msg);
			issetViewCall=true;
		}
		return framingRect;
	}
	...
	public void setSetView_handler(Handler setView_handler) {
		this.setView_handler = setView_handler;
	}
}
